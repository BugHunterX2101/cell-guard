...
def response(status, body):
    # CORS headers are not set here: AgentApi's own CorsConfiguration (template.yaml)
    # already adds them to every response, and a Lambda-added header on top of that
    # produces a duplicate Access-Control-Allow-Origin header, which browsers reject.
